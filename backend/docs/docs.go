    ...
    "paths": {
        ...
        "/booking/": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request or no available rooms",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/facilities/": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Facility Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/facilities/{facility_id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Facility Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/kost/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Kost fetched successfully",
                        "schema": {
                            "allOf": [
                                {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.KostResponse"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Kost Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateKostRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/kost/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Kost Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateKostRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/payments/": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Payment already exists or booking already paid",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/payments/webhook": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Midtrans Webhook Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/room-facilities/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Room Facility Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateRoomFacilityRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Room facility created successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.RoomFacilityResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Delete Room Facility Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.DeleteRoomFacilityRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Room facility deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "404": {
                        "description": "Room or facility not found",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
    ...
    "definitions": {
        ...
        "dto.CreateFacilityRequest": {
            ...
            "properties": {
                "icon_url": {
                    "type": "string",
                    "example": "https://example.com/ac-icon.svg"
                },
                "name": {
                    "type": "string",
                    "example": "AC"
        ...
        "dto.CreateKostRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "A comfortable kost near the university"
                },
                "is_premium": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.FacilityResponse": {
            ...
            "properties": {
                "icon_url": {
                    "type": "string",
                    "example": "https://example.com/wifi-icon.svg"
                },
                "id": {
                    "type": "integer",
                    "example": 1
